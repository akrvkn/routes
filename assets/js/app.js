const points = [
  ...
  { name: "Коневец", latitude: 60.860160,  longitude: 30.610120 },
  ...
  { name: "Юрьевец", latitude: 57.357648,   longitude: 43.154380 },
  { name: "Чкаловск", latitude: 56.776495,   longitude: 43.292538 },
  { name: "Городец", latitude: 56.646093,    longitude: 43.441371 },
  { name: "Н.Новгород", latitude: 56.331513,  longitude: 43.987190 },
  ...
  { name: "Усовка", latitude: 51.791925,  longitude: 46.490310 },
  ...
  { name: "Нижнекамск", latitude: 55.657200,  longitude: 51.702794 },
...
function renderRouteMap(line, locations) {
  const map = L.map("map").setView([55.850701, 37.465197], 13);
...
//let res = itinerary(mapTree, "Москва (СРВ)", "Валаам");
//console.log(res);